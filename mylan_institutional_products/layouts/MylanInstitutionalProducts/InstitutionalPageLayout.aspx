        ...
        <div class="content-container" id="ctl1">
            ...
            <div class="footer" id="ctl10">
                <div class="footer-container">
                    <ul class="body-warnings">
                        <li id="c"><strong>Controlled Substance</strong></li>
                        <li id="lf"><strong>Not Made With Natural Rubber Latex</strong></li>
                        <li id="pf"><strong>Preservative Free</strong></li>
                    </ul>
                    <ul class="body-warnings">
                        <li id="bw"><strong>Boxed Warning</strong> - This drug has a boxed warning. Please contact Customer Relations (1.800.848.0462) for the complete prescribing information for this product, including the boxed warning.</li>
                    </ul>
                    <ul>
